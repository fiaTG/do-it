  ...
  return (
    <div className="flex min-h-screen">
      <div className="relative hidden w-1/2 lg:block">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-brand via-brand/50 to-brand/10" />
      ...
      <div className="flex w-full items-center justify-center bg-cream p-6 lg:w-1/2">
        <div className="w-full max-w-sm">
          <h1 className="mb-1 text-2xl font-bold text-brand">{title}</h1>
