...
| [0029](adr/0029-rechtstexte-beschaffung-und-einbindung.md) | Rechtstexte – Beschaffung & Einbindung (Phasen-Zuordnung) | Akzeptiert |
...
| ~~Kalender-Freigabe (iCal-Export)~~ | – | Premium ✔ | ✔ umgesetzt 2026-07-17 (ADR-0024): geheime .ics-Abo-URL je Familie (Token rotierbar), Serien als echte RRULEs, 10-min-Cache, Premium-Pause statt Löschung – Nidula-Termine erscheinen im Google/Apple/Outlook-Kalender |
